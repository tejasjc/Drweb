...
export class CardJsAsync extends Component {
    constructor(props) {
        super(props);
        this.state = {
          imagedata:[],
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Card key="front" title="Javascript Async" headStyle={{fontSize:"20px",fontFamily:"system-ui",background:"#2196f3",color:"white"}}>
        ...
        <Card key="back" title="Javascript Async" style={{ width: 556,height:300 }} headStyle={{fontSize:"20px",fontFamily:"system-ui",background:"#2196f3",color:"white"}}>
