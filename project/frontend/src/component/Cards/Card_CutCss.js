...
export class CardCutCss extends Component {
    constructor(props) {
        super(props);
        this.state = {
          imagedata:[],
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Card key="front" title="Remove unused css" headStyle={{fontSize:"20px",fontFamily:"system-ui",background:"#2196f3",color:"white"}}>
        ...
        <Card key="back" title="Remove unused css" style={{ width: 556,height:300 }} headStyle={{fontSize:"20px",fontFamily:"system-ui",background:"#2196f3",color:"white"}}>
